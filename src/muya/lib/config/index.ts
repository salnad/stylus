...
export const DEVICE_MEMORY = navigatorWithDeviceMemory.deviceMemory || 4
...
export const DEFAULT_TURNDOWN_CONFIG = Object.freeze({
  ...
  blankReplacement (content: string, node: Parameters<TurndownBlankReplacement>[1], _options: unknown) {
...
export const FORMAT_MARKER_MAP = Object.freeze<Record<string, string | MarkerPair>>({
  em: '*',
  inline_code: '`',
  strong: '**',
  del: '~~',
...
export const isOsx = navigator.userAgent.includes('Mac OS X')
