...
export interface InlineRuleMap {
  strong: RegExp
  em: RegExp
  inline_code: RegExp
  image: RegExp
...
export interface InlineExtensionRuleMap {
  superscript: RegExp
  subscript: RegExp
...
export const beginRules: BeginRuleMap = {
  hr: /^(\*{3,}$|^\-{3,}$|^\_{3,}$)/,
  code_fense: /^(`{3,})([^`]*)$/,
  header: /(^ {0,3}#{1,6}(\s{1,}|$))/,
...
export const inlineRules: InlineRuleMap = {
...
// Markdown extensions (not belongs to GFM and Commonmark)
export const inlineExtensionRules: InlineExtensionRuleMap = {
