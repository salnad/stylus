...
type InlineRuleValue = string | RegExp | typeof noop

interface InlineRules {
  escape: RegExp
  autolink: RegExp
  url: RegExp | typeof noop
  tag: string | RegExp
  link: RegExp
  reflink: RegExp
  nolink: RegExp
  ...
  code: RegExp
  br: RegExp
  del: RegExp | typeof noop
  text: RegExp
  emoji: RegExp | typeof noop
  math: RegExp
  superscript: RegExp
  subscript: RegExp
...
export const normal = Object.assign({}, inline) as InlineRules
