...
type BlockRuleValue = string | RegExp | typeof noop

interface BlockRules {
  newline: RegExp
  code: RegExp
  fences: RegExp | typeof noop
  hr: RegExp
  heading: RegExp
  blockquote: RegExp
  list: RegExp
  html: string | RegExp
  def: RegExp
  nptable: BlockRuleValue
  table: BlockRuleValue
  lheading: RegExp
  _paragraph: RegExp
  paragraph: RegExp
  text: RegExp
...
export const normal = Object.assign({}, block) as BlockRules
