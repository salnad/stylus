// special character
interface EscapeCharacterMap {
  [escapeCharacter: string]: string
}
...
const escapeCharactersMap = escapeCharacters.reduce<EscapeCharacterMap>((acc, escapeCharacter, index) => {
  return Object.assign(acc, { [escapeCharacter]: characters[index] as string })
}, {})
