...
export type MarkTextBrowserWindowOptions = BrowserWindowConstructorOptions & {
  zoomFactor: number
}
...
export const editorWinOptions = Object.freeze<MarkTextBrowserWindowOptions>({
  minWidth: 550,
  minHeight: 350,
  webPreferences: {
...
export const preferencesWinOptions = Object.freeze<MarkTextBrowserWindowOptions>({
  minWidth: 450,
  minHeight: 350,
  width: 950,
  height: 650,
