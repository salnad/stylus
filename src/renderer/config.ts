...
export const DEFAULT_STYLE: DefaultStyle = Object.freeze({
...
export const railscastsThemes = Object.freeze(['dark', 'material-dark'] as const)
export const oneDarkThemes = Object.freeze(['one-dark'] as const)
